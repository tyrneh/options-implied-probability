...
OIPD generates a probability distribution-a single curve that describes the probabilities of future prices for a security-from options data. These probabilities reflect the consensus, risk-neutral expectations of all market participants. While markets don't predict the future with certainty, under the efficient market hypothesis, these collective expectations represent the best available estimate of what might happen.
...
- Market-implied view: Ahead of earnings and a central-bank meeting, pull option-implied distributions for holdings. The forward-looking tails point to a 6% VaR—twice the historical figure—signalling the need to hedge, trim, or tighten limits

Corporates: What proportion of my commodity exposure should I hedge next quarter?
- Typically, my finance team hedges a fixed 70% of my jet fuel exposure, while leaving 30% unhedged to benefit if oil prices falls
